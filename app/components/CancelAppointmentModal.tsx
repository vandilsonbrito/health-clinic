...
export default function CancelAppointmentModal() {
  ...
  const { isCancelAppointmentModalOpen, setIsCancelAppointmentModalOpen, setRespondedValueModalAppointmentCancel } = useGlobalStore();

  const handleModalBtn = (value: boolean) => {
    setRespondedValueModalAppointmentCancel(value);
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Você gostaria mesmo de Cancelar a Consulta?
                    </p>
                  </div>
                </div>
              </div>
