...
export default function WhoWeAre() {
    ...
    return (
        <section className="w-full max-w-6xl h-full flex flex-col-reverse xl:flex-row items-start  px-8 xl:px-0 py-10 lg:py-12 text-black " id="who-we-are" data-aos="fade-up">
